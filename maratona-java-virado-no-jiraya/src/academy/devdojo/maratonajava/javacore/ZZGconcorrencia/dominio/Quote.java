...
public class Quote {
    ...
    /**
     * Creates new Quote object from the value following the pattern storeName:price:dicountCode
     * @param value the containing storeName:price:dicountCode
