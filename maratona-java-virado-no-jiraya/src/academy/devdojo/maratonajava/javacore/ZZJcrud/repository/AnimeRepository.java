...
public class AnimeRepository {
    public static List<Anime> findByName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepareStatementFindyByName(conn, name);
    ...
    private static PreparedStatement createPrepareStatementFindyByName(Connection conn, String name) throws SQLException {
        String sql = """
    ...
    public static Optional<Anime> findById(Integer id) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepareStatementFindyById(conn, id);
             ResultSet rs = ps.executeQuery()) {
    ...
    private static PreparedStatement createPrepareStatementFindyById(Connection conn, Integer id) throws SQLException {
        String sql = """
                SELECT a.id, a.name, a.episodes, a.producer_id, p.name as 'producer_name' FROM anime_store.anime  a inner join
                anime_store.producer p on a.producer_id = p.id
                where a.id = ?;
    ...
    private static PreparedStatement createPrepareStatementSave(Connection conn, Anime anime) throws
            SQLException {
